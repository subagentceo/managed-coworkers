...
![](https://iterable.com/wp-content/uploads/2026/04/b60a6-1m2ofnyfjqzp0l1dobqejgw.png)

In a previous blog post, we compared the two most popular mobile games of 2016: [Pokémon Go and Super Mario Run](https://iterable.com/blog/pokemon-go-vs-super-mario-run-which-engages-users-better). These two Nintendo properties may have the same advantage of capitalizing on ’90s nostalgia, but their different business models play a larger role on their user engagement strategies.
...
For this reason, it’s not surprising that premium games like these generate a significant portion of their revenue from merchandise. Paying $10 upfront for Super Mario Run is a much easier pill to swallow when Nintendo has spent decades building loyalty by selling everything from t-shirts and keychains to [Campbell’s soup](https://www.target.com/p/campbell-s-condensed-classic-recipe-super-mario-soup-10-5-oz/-/A-15368532?lnk=rec%7Cpdpipadh1%7Crelated_prods_vv%7Cpdpipadh1%7C15368532%7C2).

Premium, however, is the least common mobile gaming business model: [App Annie](https://www.appannie.com/insights/market-data/app-monetization-report-2016/) reports that in-app advertising and freemium are projected to account for 90 percent of market share in the mobile app industry by 2020.
...
On the other hand, user engagement is absolutely vital to convert freemium gamers into paid users. To develop a true [omni-channel growth marketing campaign](https://iterable.com/product/), it’s important to take a three-pronged approach, coordinating emails, push and in-app notifications with relevant messages that reinforce one another and encourage users to complete certain actions.
...
-   _Goal:_ Welcome and educate new users
-   _Recommended channel:_ Email

**Stage 2: Activity**

The battle for user attention is a cutthroat one: mobile analytics research shows that 24 percent of gamers [never return after their first session](https://pm.appsee.com/2015/10/13/gaming-app-user-retention-only-22-return-after-one-month/) and only 22 percent return one month after download, so the key is motivating customers to maintain a regular level of activity.
...
-   _Goal:_ Motivate users to play regularly
-   _Recommended channel:_ Push notification
...
-   _Goal:_ Reward users for gaming accomplishments
-   _Recommended channel:_ In-app notification
...
-   _Goal:_ Convert users into paid customers
-   _Recommended channel:_ In-app notification

**Stage 5: Reactivation**

No marketer wants their users to go dark, but it’s bound to happen if they’re not properly engaged. Even the uber-popular Pokémon Go lost [79 percent of its users](https://www.forbes.com/forbes/welcome/?toURL=https://www.forbes.com/sites/davidthier/2016/09/13/pokemon-go-has-lost-79-of-its-paying-players-since-launch-but-thats-fine/&refURL=https://blog.iterable.com/pok%C3%A9mon-go-vs-super-mario-run-which-engages-users-better-541d2da78824&referrer=https://blog.iterable.com/pok%C3%A9mon-go-vs-super-mario-run-which-engages-users-better-541d2da78824#5eebc535526c) in the two months after the game’s release, perhaps because it takes more than puny Pidgeys to convince people to venture outside.
...
-   _Goal:_ Re-engage inactive users
-   _Recommended channel:_ Email
...
Want to learn how to make your omni-channel marketing more successful? [Request a demo](https://iterable.com/demo) of the Iterable platform today.
