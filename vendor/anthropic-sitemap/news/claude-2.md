...
Claude 2 powers our chat experience, and is generally available in the US and UK. We are working to make Claude more globally available in the coming months. You can now [create an account](https://claude.ai/redirect/website.v1.b1e91954-cb9c-4711-8653-65844b570815) and start talking to Claude in natural language, asking it for help with any tasks that you like. Talking to an AI assistant can take some trial and error, so [read up on our tips](https://console.anthropic.com/docs/prompt-design) to get the most out of Claude.
