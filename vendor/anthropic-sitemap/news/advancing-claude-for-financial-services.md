...
Earlier this month, we introduced [Agent Skills](https://www.anthropic.com/news/skills). Skills are folders that include instructions, scripts, and resources that Claude can use to perform given tasks. Skills work across all Claude apps, including [Claude.ai](http://claude.ai/redirect/website.v1.f265c1a0-05b6-45d6-ab6c-14d96884beee), Claude Code, and our API. To make Claude better at financial services tasks, we’ve added 6 new skills:
