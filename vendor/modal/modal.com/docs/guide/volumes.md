...
This feature is in beta. We'd love to hear your feedback — please reach out via [Slack](/slack) or email us at <support@modal.com>. Instructions specific to v2 Volumes will be annotated with 🌱 below.
...
This feature is in beta. We'd love to hear your feedback — please reach out via [Slack](/slack) or email us at <support@modal.com>. We cannot yet guarantee that no data will be lost, so we don't recommend using Volumes v2 for mission-critical data at this time.
