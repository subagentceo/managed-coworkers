...
This feature is currently in alpha. See [feature maturity](/docs/guide/feature-maturity) for more details. Compatibility with [Sandbox snapshots](/docs/guide/sandbox-snapshots) is known to be limited; in particular, Docker state is currently not captured when taking a [filesystem snapshot](/docs/guide/sandbox-snapshots#filesystem-snapshots).
