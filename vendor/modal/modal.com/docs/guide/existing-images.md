...
REGISTRY_PASSWORD=dckr_pat_<REDACTED>  # chassis mirror: GitHub secret scanning blocks the placeholder upstream token; see modal.com/docs/guide/existing-images for original
```
