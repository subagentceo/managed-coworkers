...
| Filesystem snapshots                  | [Sandbox filesystem snapshots](/docs/guide/sandbox-snapshots)                                                        | Persistent until you delete them (stored as Images)                                                     |
| Directory snapshots                   | [Sandbox directory snapshots](/docs/guide/sandbox-snapshots)                                                         | 30 days after last creation or use                                                                      |
