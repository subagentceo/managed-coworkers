...
✅ Actions charged (~15% cost of a credit)

Data Costs (in Credits)

Higher (old pricing)

50% cheaper on 70+ enrichments
...
Credit Top-up Premium

50%

30%

Cost Per Credit (Launch/Starter tier)

~$0.07–0.08

~$0.05

Cost Per Credit (Pro/Growth tier)

~$0.012–0.016

Lower with enrichment discounts
...
✅ Growth (1 sync), Enterprise (2 syncs)

New Integrations

❌ Future integrations blocked
...
✅ New releases prioritized

Functions (Repeatable Workflows)
...
❌ Legacy Pro does not qualify

✅ Growth+ (priority queue), Enterprise (dedicated Slack)
