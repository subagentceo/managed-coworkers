...
Arkose Edge API is a lightweight, high-performance integration point that provides:
...
**Please refer the following sections to learn more about the Edge API:**

* [Request Parameters](https://developer.arkoselabs.com/docs/edge-api-request-parameters#/)
* [Response Parameters](https://developer.arkoselabs.com/docs/edge-api-response-parameters#/)
