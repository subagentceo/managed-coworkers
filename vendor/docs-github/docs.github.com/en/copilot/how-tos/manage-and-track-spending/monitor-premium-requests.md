...
> \[!IMPORTANT] Starting June 1, 2026, GitHub is moving Copilot from request-based billing to usage-based billing. See [Usage-based billing for organizations and enterprises](/en/copilot/concepts/billing/usage-based-billing-for-organizations-and-enterprises).
...
> \[!IMPORTANT]
> **Starting April 20, 2026**, Copilot Pro, Copilot Pro+, and student plans have tighter usage limits: Session limits and weekly (7 day) limits. VS Code and GitHub Copilot CLI both display your available usage when you are approaching a limit. See [Usage limits for GitHub Copilot](/en/copilot/concepts/usage-limits).
