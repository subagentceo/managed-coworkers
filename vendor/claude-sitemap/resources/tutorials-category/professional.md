...
[Read use case](/resources/tutorials/delegating-your-first-task-in-claude-cowork)Read use case
...
[Read use case](/resources/tutorials/customize-claude-cowork)Read use case
...
[Read use case](/resources/tutorials/working-with-claude-opus-4-7)Read use case
...
[Read use case](/resources/tutorials/choosing-between-claude-cowork-or-chat)Read use case
...
[Read use case](/resources/tutorials/how-to-customize-plugins-in-cowork)Read use case
...
[Read use case](/resources/tutorials/cowork-onboarding-guide)Read use case
...
[Read use case](/resources/tutorials/dispatch-in-claude-cowork)Read use case
...
[Read use case](/resources/tutorials/navigating-the-claude-desktop-app)Read use case
...
[Read use case](/resources/tutorials/claude-cowork-a-research-preview)Read use case
...
[Read use case](/resources/tutorials/choosing-the-right-claude-model)Read use case
...
[日本語 (Japan)](/ja/resources/tutorials-category/professional)

[Deutsch (Germany)](/de/resources/tutorials-category/professional)

[Français (France)](/fr/resources/tutorials-category/professional)

[한국어 (South Korea)](/ko/resources/tutorials-category/professional)